...
![Histogram of Save % - Advanced](Result_screenshots/histogram_advanced.png)
...
![Histogram of Save % - Eliminated](Result_screenshots/histogram_eliminated.png)
...
![Boxplot of Save % by Outcome](Result_screenshots/boxplot_savepct.png)
...
| `Result_screenshots/` | Terminal output and plots from running each script |
